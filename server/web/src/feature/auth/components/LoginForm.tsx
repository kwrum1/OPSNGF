            ...
            <CardContent className="space-y-4 pt-4">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <Button
                            type="submit"
                            className="w-full mt-6 py-6 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg animate-fade-in-up [animation-delay:300ms] hover:translate-y-[-2px]"
                            disabled={isLoading}
                        >
